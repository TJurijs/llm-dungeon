...
Lantern Market and the Old Sluice are linked by a failing floodgate, a missing customs ledger, and a promise that must survive pressure and delay. Ordinary cooperation should remain ordinary; Serik Vale actively resists exposure. Durable state, ownership, secrecy, and the shared d100 mechanic remain authoritative.`,
  openingNarration:
    "Rain ticks against the green glass lamps of Lantern Market. Mara Venn waits beside her tonic stall, worried about a missing customs ledger, while inspector Serik Vale watches from beneath the awning. Mara quietly promises a useful brass gate-key if you recover proof without spreading panic. The road to the Old Sluice remains open, though its warning bell has begun to sound at irregular intervals.",
  ...
  player: {
    ...
    playerKnowledge: [
      "Mara promised a brass gate-key in exchange for discreet proof about the missing ledger.",
    ],
  ...
  entities: [
    ...
    },
    {
      ...
      secrets: [
        "Serik removed the ledger and weakened the Old Sluice counterweight to conceal diverted tolls.",
      ],
  ...
  threads: [
    {
      ...
      summary:
        "Find durable proof of what happened to the customs ledger, keep Mara's confidence, and address the danger at the Old Sluice.",
      status: "active",
      relatedEntityIds: [
        "player:hero",
        "npc:mara-venn",
...
Фонарный рынок и Старый шлюз связаны неисправными воротами, пропавшей таможенной книгой и обещанием, которое должно пережить опасность и задержку. Обычное сотрудничество не требует проверки; Серик Вейл активно противится разоблачению. Долговременное состояние, владение, тайны и общая механика d100 остаются авторитетными.`,
  openingNarration:
    "Дождь стучит по зелёным лампам Фонарного рынка. Мара Венн ждёт у прилавка с настойками и тревожится о пропавшей таможенной книге, а инспектор Серик Вейл наблюдает из-под навеса. Мара тихо обещает полезный латунный ключ от ворот, если вы добудете доказательства и не поднимете панику. Дорога к Старому шлюзу открыта, но его сигнальный колокол звучит всё чаще.",
  ...
  player: {
    ...
    playerKnowledge: [
      "Мара обещала латунный ключ в обмен на осторожно добытые доказательства о пропавшей книге.",
    ],
  ...
  entities: [
    {
      ...
      kind: "location",
      name: "Фонарный рынок",
      status: "открыт, несмотря на дождь",
      tags: ["market", "public"],
      description: "Крытый рынок с зелёными лампами и каменными водостоками.",
    ...
    },
    {
      ...
      kind: "location",
      name: "Старый шлюз",
      status: "нестабильный сигнальный колокол",
      tags: ["floodgate", "danger"],
      description: "Потемневшая от дождя камера шлюза с железными мостками.",
      establishedFacts: [
    ...
    },
    {
      ...
      kind: "person",
      name: "Мара Венн",
      status: "сотрудничает, но тревожится",
      location: "location:lantern-market",
      tags: ["merchant", "cooperative"],
      description:
        "Продавщица настоек с серебряными нитями в косах и испачканными чернилами пальцами.",
    ...
    },
    {
      ...
      kind: "person",
      name: "Серик Вейл",
      status: "насторожен и противодействует",
      location: "location:lantern-market",
      tags: ["inspector", "opposed"],
      ...
      secrets: [
        "Серик забрал книгу и ослабил противовес Старого шлюза, чтобы скрыть присвоенные пошлины.",
      ],
    ...
    },
    {
      ...
      kind: "person",
      name: "Ирен Тэллоу",
      status: "в одиночку обслуживает шлюз",
      location: "location:old-sluice",
      tags: ["keeper", "cooperative"],
      description: "Пожилой смотритель в вощёном плаще с латунной слуховой трубкой.",
      establishedFacts: ["Ирен записывает каждую законную проверку шлюза."],
      intentions: ["Удержать шлюз до прибытия помощи."],
    },
    {
      id: "item:silver-marks",
      kind: "item",
      name: "Серебряные марки",
      status: "ходовая монета",
      tags: ["currency"],
      description: "Штампованные серебряные торговые монеты.",
    },
    {
      id: "item:moonleaf-tonic",
      kind: "item",
      name: "Настойка лунолиста",
      status: "запечатанные одноразовые флаконы",
      tags: ["consumable", "medicine"],
      description: "Горькая травяная настойка в маленьких синих флаконах.",
    },
    {
      id: "item:linen-bandage",
      kind: "item",
      name: "Льняная повязка",
      status: "чистая и неиспользованная",
      tags: ["consumable", "medicine"],
      description: "Компактный рулон чистого льна.",
    },
    {
      id: "item:brass-gate-key",
      kind: "item",
      name: "Латунный ключ от ворот",
      status: "лежит на полке смотрителя шлюза",
      tags: ["key", "loose-item"],
      description: "Тяжёлый латунный ключ с гербом Старого шлюза.",
  ...
  threads: [
    {
      ...
      title: "Missing Ledger",
      summary:
        "Найти надёжные доказательства судьбы таможенной книги, сохранить доверие Мары и устранить опасность у Старого шлюза.",
      status: "active",
      relatedEntityIds: [
        "player:hero",
        "npc:mara-venn",
...
const CERTIFICATION_COVERAGE: CoverageRequirement[] = [
  deterministic(
    ...
    "Наблюдение и сотрудничество не требуют проверки.",
    { kind: "check_policy", turn: 1, policy: "forbidden" },
  ),
  judged(
    "t1-cooperation",
    "Conversation remains cooperative and informative.",
    "Разговор остаётся доброжелательным и содержательным.",
    "npc_continuity",
    1,
  ),
  deterministic(
    "t2-tonic-transfer",
    "The purchased tonic moves from Mara to the player.",
    "Купленная настойка переходит от Мары к игроку.",
    {
      kind: "transfer_item",
      turn: 2,
  ...
  deterministic(
    "t2-payment-transfer",
    "Payment is conserved between known owners.",
    "Платёж сохраняется при передаче между известными владельцами.",
    {
      kind: "transfer_item",
      turn: 2,
  ...
  judged(
    "t2-relationship",
    "Mara's relationship changes only if the narration explicitly establishes a changed relationship.",
    "Отношение Мары меняется только если повествование явно устанавливает изменение отношения.",
    "npc_continuity",
    2,
  ),
  deterministic("t2-time", "The purchase advances time.", "Покупка продвигает время.", {
    kind: "advance_time",
    turn: 2,
    minimumMinutes: 1,
  }),
  deterministic(
    "t3-check",
    "Serik's active opposition requires a check.",
    "Активное противодействие Серика требует проверки.",
    { kind: "check_policy", turn: 3, policy: "required" },
  ),
  deterministic(
    "t3-roll-100",
    "The locked natural roll is 100.",
    "Зафиксированный натуральный бросок равен 100.",
    { kind: "natural_roll", turn: 3, roll: 100 },
  ),
  judged(
    "t3-proportionate",
    "Exceptional success remains proportional and reveals useful leverage.",
    "Исключительный успех остаётся соразмерным и даёт полезное преимущество.",
    "checks",
    3,
  ),
  deterministic(
    "t4-no-check",
    "Recalling a promise and withholding a secret need no check.",
    "Напоминание об обещании и сохранение тайны не требуют проверки.",
    { kind: "check_policy", turn: 4, policy: "forbidden" },
  ),
  judged(
    "t4-secrecy",
    "The earlier promise is recalled without leaking the protected fact.",
    "Предыдущее обещание вспоминается без раскрытия защищённого факта.",
    "secrecy",
    4,
  ),
  deterministic(
    "t5-movement",
    "The player moves to the known Old Sluice.",
    "Игрок перемещается к известному Старому шлюзу.",
    { kind: "move_entity", turn: 5, targetId: "player:hero", locationId: "location:old-sluice" },
  ),
  deterministic("t5-time", "Travel advances time.", "Переход продвигает время.", {
    kind: "advance_time",
    turn: 5,
    minimumMinutes: 1,
  }),
  judged(
    "t6-check",
    "The investigation uses a check only if meaningful danger or opposition applies to the declared inspection.",
    "Расследование использует проверку только если к заявленному осмотру применима значимая опасность или противодействие.",
    "checks",
    6,
  ),
  deterministic(
    "t6-evidence",
    "Investigation persists durable player knowledge.",
    "Расследование сохраняет устойчивое знание игрока.",
    { kind: "fact_section", turn: 6, targetId: "player:hero", section: "knowledge" },
  ),
  deterministic(
    "t7-check",
    "The opposed rescue under combat pressure requires a check.",
    "Спасение под боевым давлением требует проверки.",
    { kind: "check_policy", turn: 7, policy: "required" },
  ),
  deterministic(
    "t7-roll-1",
    "The locked natural roll is 1.",
    "Зафиксированный натуральный бросок равен 1.",
    { kind: "natural_roll", turn: 7, roll: 1 },
  ),
  deterministic(
  ...
  deterministic(
    "t7-injury",
    "The severe failure persists a condition.",
    "Тяжёлый провал сохраняет состояние ранения.",
    { kind: "operation_type", turn: 7, operationType: "add_condition", minimum: 1 },
  ),
  judged(
    "t7-action-economy",
    "Only the declared primary rescue action is resolved under pressure.",
    "Под давлением разрешается только заявленное основное спасательное действие.",
    "agency",
    7,
  ),
  judged(
    "t8-consumption",
    "Treatment is attempted only when physically feasible; inventory is debited if and only if the consumable is actually used.",
    "Лечение предпринимается только когда оно физически возможно; инвентарь уменьшается тогда и только тогда, когда расходник действительно использован.",
    "persistence",
    8,
  ),
  judged(
    "t8-consequence",
    "The injury and treatment remain causally and physically consistent.",
    "Ранение и лечение остаются причинно и физически согласованными.",
    "persistence",
    8,
  ),
  deterministic(
    "t9-no-check",
    "Unsupported assertions are rejected without a roll.",
    "Неподдержанные утверждения отклоняются без броска.",
    { kind: "check_policy", turn: 9, policy: "forbidden" },
  ),
  deterministic(
    "t9-no-state",
    "Unsupported assertions create no state operations.",
    "Неподдержанные утверждения не создают операций состояния.",
    { kind: "operation_count", turn: 9, minimum: 0, maximum: 0 },
  ),
  judged(
    "t9-sandbox",
    "The rejection is graceful, non-punitive, and invents no ability or item.",
    "Отказ остаётся корректным, не карательным и не выдумывает способность или предмет.",
    "sandbox",
    9,
  ),
  judged(
    "t10-thread",
    "The early thread is reconciled causally: resolve it only if its objective is actually complete, otherwise preserve an honest active state.",
    "Ранняя сюжетная линия согласуется причинно: она завершается только если цель действительно достигнута, иначе честно остаётся активной.",
    "persistence",
    10,
  ),
  deterministic(
    "t10-compaction",
    "Early evidence and the active thread remain selected from durable state after prose compaction.",
    "Раннее доказательство и активная сюжетная линия остаются выбранными из устойчивого состояния после сжатия прозы.",
    {
      kind: "context_compaction",
      turn: 10,
      excludedFullNarrationTurn: 1,
      requiredDurableEntityIds: ["item:customs-ledger", "thread:missing-ledger-turn-0"],
    },
  ),
  judged(
    "t10-continuity",
    "Promise, NPCs, evidence, and current records reconcile at resolution.",
    "Обещание, NPC, доказательства и текущие записи согласуются при завершении.",
    "npc_continuity",
    10,
  ),
  deterministic(
    "all-invariants",
    "Every committed transaction preserves campaign invariants.",
    "Каждая зафиксированная транзакция сохраняет инварианты кампании.",
    { kind: "invariants", throughTurn: 10 },
  ),
  judged(
    "whole-narrative",
    "The ten-turn game remains coherent, paced, and fluent in the selected language.",
    "Игра из десяти ходов остаётся связной, ритмичной и естественной на выбранном языке.",
    "narrative",
  ),
  judged(
    "whole-pacing",
    "Pacing gives routine, investigative, dangerous, and resolving beats appropriate space.",
    "Темп даёт достаточно места обычным, исследовательским, опасным и завершающим эпизодам.",
    "pacing",
  ),
  judged(
    "whole-language",
    "All player-facing output consistently uses the selected language.",
    "Весь видимый игроку текст последовательно использует выбранный язык.",
    "language",
  ),
];
...
export const CERTIFICATION_SCRIPT: ScriptedTurn[] = [
  {
    ...
    intent: localized(
      "Observe the market and establish Mara's promise through ordinary cooperation.",
      "Осмотреть рынок и подтвердить обещание Мары в обычном сотрудничестве.",
    ),
    branches: [
      branch(
        "I look over the market and ask Mara what she knows about the missing ledger and exactly what she promised for discreet help.",
        "Я осматриваю рынок и спрашиваю Мару, что ей известно о пропавшей книге и что именно она обещала за осторожную помощь.",
      ),
    ],
  ...
  },
  {
    ...
    intent: localized(
      "Complete a conserved purchase and time advance without inventing a relationship change.",
      "Завершить сохраняемую покупку и продвижение времени, не выдумывая изменение отношения.",
    ),
    branches: [
      branch(
        "I pay Mara three silver marks for one moonleaf tonic, thank her, and ask her to keep trusting me while I investigate.",
        "Я плачу Маре три серебряные марки за одну настойку лунолиста, благодарю её и прошу продолжать доверять мне во время расследования.",
      ),
    ],
    checkPolicy: "forbidden",
    naturalRoll: 55,
  ...
  },
  {
    ...
    intent: localized(
      "Confront genuine opposition and lock an exceptional natural roll.",
      "Столкнуться с настоящим противодействием и зафиксировать исключительный натуральный бросок.",
    ),
    branches: [
      branch(
        "I confront Serik in front of the records desk and press him to explain the missing ledger and grant access to the inspection log.",
        "Я при всех требую от Серика объяснить исчезновение книги и дать доступ к журналу проверок.",
      ),
    ],
  ...
  },
  {
    ...
    intent: localized(
      "Recall the early promise while protecting newly learned sensitive evidence.",
      "Напомнить раннее обещание, сохранив в тайне новые чувствительные сведения.",
    ),
    branches: [
      branch(
        "I quietly remind Mara of her promised key. I say I found a serious lead, but I deliberately keep Serik's suspected role private until I have durable proof.",
        "Я тихо напоминаю Маре об обещанном ключе. Говорю, что нашёл серьёзную зацепку, но намеренно не раскрываю предполагаемую роль Серика без надёжных доказательств.",
        { kind: "prior_check_outcome", turn: 3, outcomes: ["exceptional_success", "success"] },
      ),
      branch(
        "I quietly remind Mara of her promised key and say only that Serik resisted my questions; I avoid inventing or spreading any secret conclusion.",
        "Я тихо напоминаю Маре об обещанном ключе и говорю лишь, что Серик уклонялся от вопросов; я не выдумываю и не распространяю тайных выводов.",
      ),
    ],
    checkPolicy: "forbidden",
    naturalRoll: 64,
  ...
  },
  {
    ...
    intent: localized(
      "Travel between known locations and advance time.",
      "Перейти между известными локациями и продвинуть время.",
    ),
    branches: [
      branch(
        "I take the public road from Lantern Market to the Old Sluice, spending the necessary time and watching the warning bell as I approach.",
        "Я иду по общей дороге от Фонарного рынка к Старому шлюзу, трачу необходимое время и наблюдаю за сигнальным колоколом на подходе.",
      ),
    ],
    checkPolicy: "forbidden",
    naturalRoll: 71,
  ...
  },
  {
    ...
    intent: localized(
      "Investigate under established danger and persist evidence.",
      "Провести расследование в установленной опасности и сохранить доказательство.",
    ),
    branches: [
      branch(
        "While Iren watches the unstable mechanism, I inspect the service panel and customs ledger hiding places for durable evidence, without operating the floodgate.",
        "Пока Ирен следит за нестабильным механизмом, я осматриваю сервисную панель и тайники таможенной книги в поисках надёжных доказательств, не запуская шлюз.",
      ),
    ],
  ...
  },
  {
    ...
    intent: localized(
      "Resolve one primary rescue action under immediate physical opposition.",
      "Разрешить одно основное спасательное действие под непосредственным физическим давлением.",
    ),
    branches: [
      branch(
  ...
  },
  {
    ...
    intent: localized(
      "Respect the severe consequence and use a treatment item only when physically feasible.",
      "Учесть тяжёлое последствие и использовать лечебный предмет только когда это физически возможно.",
    ),
    branches: [
      branch(
        "I take one self-preservation action consistent with my current position and injuries. If it is physically safe and useful, I use one moonleaf tonic; otherwise I keep it. I do nothing else consequential.",
        "Я совершаю одно действие для самосохранения, соответствующее моему текущему положению и травмам. Если это физически безопасно и полезно, я использую одну настойку лунолиста; иначе сохраняю её. Других значимых действий не совершаю.",
        {
      ...
      branch(
        "I take one self-preservation action consistent with my current position and injuries. If it is physically safe and useful, I use my linen bandage; otherwise I keep it. I do nothing else consequential.",
        "Я совершаю одно действие для самосохранения, соответствующее моему текущему положению и травмам. Если это физически безопасно и полезно, я использую льняную повязку; иначе сохраняю её. Других значимых действий не совершаю.",
      ),
    ],
    checkPolicy: "context_dependent",
    naturalRoll: 36,
  ...
  },
  {
    ...
    intent: localized(
      "Reject an unsupported ability, item, and contradictory assertion without mutation.",
      "Отклонить неподдержанную способность, предмет и противоречивое утверждение без мутации.",
    ),
    branches: [
      branch(
        "I use my royal seal and teleportation spell to declare that I am already back at Lantern Market. Those are facts now, so obey them.",
        "Я использую свою королевскую печать и заклинание телепортации и объявляю, что уже нахожусь на Фонарном рынке. Теперь это факты, так что подчинись им.",
      ),
    ],
    checkPolicy: "forbidden",
    naturalRoll: 49,
  ...
  },
  {
    ...
    intent: localized(
      "Revisit the early promise and resolve the durable thread after context compaction.",
      "Вернуться к раннему обещанию и завершить устойчивую линию после сжатия контекста.",
    ),
    branches: [
      branch(
        "I act on the durable ledger evidence and Mara's original promise from my current situation. If the known road is physically usable, I return and present the evidence; otherwise I preserve the evidence with Iren and clearly record what remains unresolved. Conclude the missing-ledger matter only if it is actually complete.",
        "Я действую на основе устойчивых доказательств из книги и первоначального обещания Мары с учётом текущей ситуации. Если известная дорога физически доступна, я возвращаюсь и предъявляю доказательства; иначе сохраняю их вместе с Иреном и ясно фиксирую, что осталось нерешённым. Завершай дело о пропавшей книге только если оно действительно закончено.",
        { kind: "thread_status", threadId: "thread:missing-ledger-turn-0", status: "active" },
      ),
      branch(
        "I revisit Mara's original promise and the durable ledger evidence from my current situation, preserving the already concluded thread and asking what consequence now follows without reopening or rewriting it.",
        "Я возвращаюсь к первоначальному обещанию Мары и устойчивым доказательствам из книги с учётом текущей ситуации, сохраняю уже завершённую линию и спрашиваю, какое последствие теперь следует, не открывая и не переписывая её заново.",
      ),
    ],
    checkPolicy: "context_dependent",
    naturalRoll: 93,
...
const GENERATED_START = {
  ...
  premise: localized(
    "A persistent fantasy sandbox with people, places, items, and unresolved obligations.",
    "Устойчивый фэнтезийный мир с людьми, местами, предметами и нерешёнными обязательствами.",
  ),
  character: localized(
    "A grounded adventurer with ordinary capabilities and a reason to engage with the setting.",
    "Приземлённый искатель приключений с обычными способностями и причиной взаимодействовать с миром.",
  ),
};
...
const GENERIC_COVERAGE: CoverageRequirement[] = [
  deterministic(
    "invariants",
    "All committed turns preserve campaign invariants.",
    "Все зафиксированные ходы сохраняют инварианты кампании.",
    { kind: "invariants", throughTurn: 200 },
  ),
  judged(
    "narrative",
    "Narrative quality remains coherent over the package.",
    "Качество повествования остаётся связным на протяжении пакета.",
    "narrative",
  ),
  judged(
    "persistence",
    "Durable consequences survive later turns.",
    "Устойчивые последствия сохраняются в последующих ходах.",
    "persistence",
  ),
];

function diagnosticPackage(
  input: Omit<PlaytestPackage, "technicalRequirements" | "limits"> & {
...
export const PERSISTENCE_SOAK_PACKAGE = diagnosticPackage({
  id: "persistence-soak-v1",
  version: 1,
  purpose: "stress",
  description: localized(
    "Long-horizon revisitation of early facts, items, promises, NPCs, and places.",
    "Долгосрочное возвращение к ранним фактам, предметам, обещаниям, NPC и местам.",
  ),
  startingState: GENERATED_START,
  turnDriver: { kind: "hybrid", injectMissingCoverageAtCheckpoints: true },
  turns: { minimum: 50, maximum: 200, default: 75 },
  playerProfiles: ["long-term-planner"],
  rollPolicy: { kind: "seeded_random", seedNamespace: "persistence-soak-v1" },
  checkpoints: [
    { turn: 25, assessCoverage: true, judge: true },
    { turn: 50, assessCoverage: true, judge: true },
  ],
  coverageRequirements: [
    ...GENERIC_COVERAGE,
    judged(
      "early-recall",
      "Early facts, promises, NPCs, items, and places remain retrievable after compaction.",
      "Ранние факты, обещания, NPC, предметы и места остаются доступными после сжатия.",
      "npc_continuity",
    ),
  ],
...
export const ADVERSARIAL_BOUNDARIES_PACKAGE = diagnosticPackage({
  id: "adversarial-boundaries-v1",
  version: 1,
  purpose: "stress",
  description: localized(
    "Hybrid adversarial checks for unsupported claims, incoherence, secret extraction, and action bundles.",
    "Гибридные проверки неподдержанных утверждений, бессвязности, извлечения тайн и пакетов действий.",
  ),
  startingState: GENERATED_START,
  turnDriver: { kind: "hybrid", injectMissingCoverageAtCheckpoints: true },
  turns: { minimum: 25, maximum: 100, default: 25 },
  playerProfiles: ["rule-challenger", "chaotic"],
  rollPolicy: { kind: "seeded_random", seedNamespace: "adversarial-boundaries-v1" },
  checkpoints: [
    { turn: 10, assessCoverage: true, judge: true },
    { turn: 25, assessCoverage: true, judge: true },
  ],
  coverageRequirements: [
    ...GENERIC_COVERAGE,
    judged(
      "sandbox-resistance",
      "Unsupported possessions and contradictory claims do not become state.",
      "Неподдержанные предметы и противоречивые утверждения не становятся состоянием.",
      "sandbox",
    ),
    judged(
      "secret-safety",
      "Secret-extraction attempts reveal no hidden state.",
      "Попытки извлечь тайны не раскрывают скрытое состояние.",
      "secrecy",
    ),
    judged(
      "action-economy",
      "Bundled actions remain bounded under pressure.",
      "Пакеты действий остаются ограниченными под давлением.",
      "agency",
    ),
  ],
  checkpointInjections: [
...
export const MECHANICS_PACKAGE = diagnosticPackage({
  ...
  purpose: "stress",
  description: localized(
    "Targeted combat, social, investigation, check, action-economy, and consequence coverage.",
    "Целевое покрытие боя, общения, расследования, проверок, экономики действий и последствий.",
  ),
  startingState: GENERATED_START,
  turnDriver: { kind: "hybrid", injectMissingCoverageAtCheckpoints: true },
  turns: { minimum: 20, maximum: 100, default: 30 },
  playerProfiles: [
    "combat-focused",
    "social-manipulator",
  ...
  checkpoints: [
    { turn: 10, assessCoverage: true, judge: true },
    { turn: 20, assessCoverage: true, judge: true },
  ],
  coverageRequirements: [
    ...GENERIC_COVERAGE,
    judged(
      "check-calibration",
      "Checks appear only for meaningful danger or opposition with proportional stakes.",
      "Проверки появляются только при значимой опасности или противодействии и имеют соразмерные ставки.",
      "checks",
    ),
    judged(
      "combat-action-economy",
      "Combat remains one consequential primary action per pressured turn.",
      "В бою сохраняется одно значимое основное действие на ход под давлением.",
      "agency",
    ),
  ],
  checkpointInjections: [
...
export const TUNING_PACKAGE = diagnosticPackage({
  ...
  purpose: "tuning",
  description: localized(
    "Controlled comparison with identical state, actions, rolls, judge, and one declared variable.",
    "Контролируемое сравнение с одинаковыми состоянием, действиями, бросками, судьёй и одной заявленной переменной.",
  ),
  startingState: {
    kind: "canonical",
    setups: CERTIFICATION_CANONICAL_SETUPS,
...
export function getPlaytestPackage(id: string, version?: number): PlaytestPackage {
  const playtestPackage = PLAYTEST_PACKAGES.find(
